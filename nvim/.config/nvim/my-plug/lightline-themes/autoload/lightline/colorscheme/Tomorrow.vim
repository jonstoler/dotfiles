...
let s:p.normal.left = [ [ s:base02, s:blue ], [ s:base3, s:base023 ] ]
let s:p.normal.right = [ [ s:base02, s:base0 ], [ s:base1, s:base023 ] ]
let s:p.inactive.right = [ [ s:base00, s:base023 ], [ s:base00, s:base023 ] ]
let s:p.inactive.left =  [ [ s:base00, s:base023 ], [ s:base00, s:base023 ] ]
let s:p.insert.left = [ [ s:base02, s:green ], [ s:base3, s:base023 ] ]
let s:p.replace.left = [ [ s:base02, s:orange ], [ s:base3, s:base023 ] ]
let s:p.visual.left = [ [ s:base02, s:magenta ], [ s:base3, s:base023 ] ]
